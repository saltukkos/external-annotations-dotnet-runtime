...
namespace System.Linq.Parallel
{
    ...
    internal sealed class JoinQueryOperator<TLeftInput, TRightInput, [DefaultEqualityUsage] TKey, TOutput> : BinaryQueryOperator<TLeftInput, TRightInput, TOutput>
    {
    ...
    internal sealed class JoinHashLookupBuilder<TElement, TOrderKey, [DefaultEqualityUsage] THashKey> : HashLookupBuilder<TElement, TOrderKey, THashKey>
    {
