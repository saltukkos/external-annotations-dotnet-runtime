...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        private static IEnumerable<TSource> IntersectIterator<[DefaultEqualityUsage] TSource>(IEnumerable<TSource> first, IEnumerable<TSource> second, IEqualityComparer<TSource>? comparer)
        {
        ...
        private static IEnumerable<TSource> IntersectByIterator<TSource, [DefaultEqualityUsage] TKey>(IEnumerable<TSource> first, IEnumerable<TKey> second, Func<TSource, TKey> keySelector, IEqualityComparer<TKey>? comparer)
        {
