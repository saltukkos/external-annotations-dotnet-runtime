...
namespace System.Text.Json
{
    public static partial class JsonSerializer
    {
        ...
        public static TValue? Deserialize<[MeansImplicitUse(ImplicitUseKindFlags.InstantiatedNoFixedConstructorSignature, ImplicitUseTargetFlags.WithMembers)] TValue>(this JsonDocument document, JsonSerializerOptions? options = null)
        {
            if (document is null)
            {
        ...
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        [RequiresDynamicCode(SerializationRequiresDynamicCodeMessage)]
        public static object? Deserialize(this JsonDocument document, [MeansImplicitUse(ImplicitUseKindFlags.InstantiatedNoFixedConstructorSignature, ImplicitUseTargetFlags.WithMembers)] Type returnType, JsonSerializerOptions? options = null)
        {
            if (document is null)
            {
                ThrowHelper.ThrowArgumentNullException(nameof(document));
        ...
        /// <typeparamref name="TValue" /> is not compatible with the JSON.
        /// </exception>
        public static TValue? Deserialize<[MeansImplicitUse(ImplicitUseKindFlags.InstantiatedNoFixedConstructorSignature, ImplicitUseTargetFlags.WithMembers)] TValue>(this JsonDocument document, JsonTypeInfo<TValue> jsonTypeInfo)
        {
            if (document is null)
            {
                ThrowHelper.ThrowArgumentNullException(nameof(document));
        ...
        /// </exception>
        public static object? Deserialize(this JsonDocument document, [MeansImplicitUse(ImplicitUseKindFlags.InstantiatedNoFixedConstructorSignature, ImplicitUseTargetFlags.WithMembers)] Type returnType, JsonSerializerContext context)
        {
            if (document is null)
            {
                ThrowHelper.ThrowArgumentNullException(nameof(document));
