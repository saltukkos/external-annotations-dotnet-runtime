...
namespace System.Text.Json
{
    public static partial class JsonSerializer
    {
        ...
        public static JsonDocument SerializeToDocument<[MeansImplicitUse(ImplicitUseKindFlags.InstantiatedNoFixedConstructorSignature, ImplicitUseTargetFlags.WithMembers)] TValue>(TValue value, JsonSerializerOptions? options = null)
        {
        ...
        [RequiresUnreferencedCode(SerializationUnreferencedCodeMessage)]
        [RequiresDynamicCode(SerializationRequiresDynamicCodeMessage)]
        public static JsonDocument SerializeToDocument(object? value, [MeansImplicitUse(ImplicitUseKindFlags.InstantiatedNoFixedConstructorSignature, ImplicitUseTargetFlags.WithMembers)] Type inputType, JsonSerializerOptions? options = null)
        {
        ...
        /// </exception>
        public static JsonDocument SerializeToDocument<[MeansImplicitUse(ImplicitUseKindFlags.InstantiatedNoFixedConstructorSignature, ImplicitUseTargetFlags.WithMembers)] TValue>(TValue value, JsonTypeInfo<TValue> jsonTypeInfo)
        {
        ...
        /// </exception>
        public static JsonDocument SerializeToDocument(object? value, [MeansImplicitUse(ImplicitUseKindFlags.InstantiatedNoFixedConstructorSignature, ImplicitUseTargetFlags.WithMembers)] Type inputType, JsonSerializerContext context)
        {
            if (context is null)
            {
