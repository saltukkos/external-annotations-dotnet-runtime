...
namespace System.Collections.Frozen
{
    ...
    internal sealed class ValueTypeDefaultComparerFrozenDictionary<[DefaultEqualityUsage] TKey, TValue> : KeysAndValuesFrozenDictionary<TKey, TValue>, IDictionary<TKey, TValue>
        where TKey : notnull
    {
