...
namespace System.Collections.Immutable
{
    ...
    public sealed partial class ImmutableSortedDictionary<TKey, [DefaultEqualityUsage] TValue> : IImmutableDictionary<TKey, TValue>, IDictionary<TKey, TValue>, IDictionary
    {
        /// <summary>
